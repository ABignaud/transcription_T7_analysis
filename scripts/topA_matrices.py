...
mat_t7_topA_file = snakemake.input.mat_topA
mat_t7_ara_rif_file = snakemake.input.mat_ara_rif
mat_t7_topA_rif_file = snakemake.input.mat_topA_rif
...
# Import matrices
subsample = 11675151
files = [mat_t7_ara_file, mat_t7_topA_file, mat_t7_ara_rif_file, mat_t7_topA_rif_file]
hic = [0, 0, 0, 0]
...
title = ["TopA- Rif-", "TopA+ Rif-", "TopA- Rif+", "TopA+ Rif+"]
...
ax.set_title("topA+ Rif+/topA- Rif+")
